...
&1.\psi_X(0)=B\\
&2.\psi_X(\alpha+1)=\psi_X(\alpha)*\omega\\
&3.\psi_X(\alpha)=sup\{\psi_X(\alpha_n)\mid \exists{\alpha_n}((\alpha_0=0)\land \forall n((\alpha_{n+1}>\alpha_n)\land(\psi_X(\alpha_{n+1})>\psi_X(\alpha_n))\land(sup{\alpha_n}=\alpha))\ ) \},isProjection(\alpha,X)\\
&4.\psi_X(h(X))=\alpha\rightarrow\psi_X(h(\alpha))fp.\\
